...
"    w.x=pg_didec(pg_pow(pg_dienc(w.x)*(gain-lift)+lift,1.0f/gamma)); w.y=pg_didec(pg_pow(pg_dienc(w.y)*(gain-lift)+lift,1.0f/gamma)); w.z=pg_didec(pg_pow(pg_dienc(w.z)*(gain-lift)+lift,1.0f/gamma)); \n" \
