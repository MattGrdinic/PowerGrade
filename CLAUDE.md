...
`Contents/Resources/LUTs` by both Makefile (`bundle-luts`) and CMake bundle assembly.
...
Sedona-LUT dependency is gone (was a third-party download — too much to ask of users). Applied in `PowerGrade::applyPreset()` from `changedParam`, **guarded
